  ...
  methods: {
    exportBtn() {
      ...
      const params = {
        ...
        score: this.listQuery.score
      }
      MonitoringPersonExport(params).then(
        res => {
          // resolve(res)
    ...
    async getList() {
      ...
      var fraudDataScore = await MonitoringPerson({
    ...
    async getRule() {
      // console.log(this.$route.query.monitorId,'this.$route.query.monitorId');
      const ruleInfo = await getRuleNameListByMonitorId(this.$route.query.monitorId)
