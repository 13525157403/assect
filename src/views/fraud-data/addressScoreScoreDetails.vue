...
import {
  addressScoreDataCardDetails,
  addressScoreDataCardDownExport,
...
export default {
  ...
  methods: {
    async exportBtn() {
      ...
      a.href = url;
      // a.download = '地址评分-累计评分数据-详情.xlsx'
      a.click();
      // 5.释放这个临时的对象url
    ...
    async getList() {
      ...
      const res = await addressScoreDataCardDetails(this.listQuery, "score");
