...
export function findListByPage(data) {
  return request({
    url: '/api/asset/management/model-info/findListByPage',
    method: 'get',
    params: data
  })
}
...
// 查询模型参数表分页数据
export function parameterfindListByPage(data) {
  return request({
    url: '/api/asset/management/model-parameter/findListByPage',
    method: 'get',
    params: data
  })
}
...
// 查询模型规则明细表分页数据-规则
export function rulefindListByPage(data) {
  return request({
    url: '/api/asset/management/model-rule-info/findListByPage',
    method: 'get',
    params: data
  })
}
...
export function strategyfindListByPage(data) {
  return request({
    url: '/api/asset/management/strategy-info/findListByPage',
    method: 'get',
    params: data
  })
}
...
//查询主动策略执行结果明细表分页数据
export function findRecordListByPage(data) {
  return request({
    url: '/api/asset/management/strategy-info/findRecordListByPage',
    method: 'get',
    params: data
  })
}
...
export function searchExport(data) {
  return request({
    url: '/api/asset/management/strategy-info/searchExport',
    method: 'get',
    params: data,
    responseType: 'blob'
  })
