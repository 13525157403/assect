...
//交易
export function getDubiousTransactions(query) {
  return request({
    url: `/api/asset/management/monitor-data-info/stats/MF/dataCard/transaction/detail/page`,
    method: 'get',
    params: query
  })
}
//交易导出
export function exportSuspiciousTransaction(query) {
  return request({
    url: '/api/asset/management/monitor-data-info/stats/MF/dataCard/transaction/detail/export',
    method: 'get',
    responseType: 'blob',
    params: query
  })
