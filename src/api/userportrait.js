...
// 用户画像-客群管理
// 列表查询
export function getUserGroupByPage(q) {
  return request({
    url: `/api/asset/management/user-group-info/getUserGroupByPage`,
    method: 'get',
    params: q
  })
}
// 停止/启用
export function stopEnable(data) {
  return request({
    url: `/api/asset/management/user-group-info/stopEnable`,
    method: 'post',
    data
  })
}
...
// 预估
export function estimateGroup(data) {
  return request({
    url: `/api/asset/management/user-group-info/estimate`,
    method: 'post',
    data
  })
}
...
export function findRuleEcho(data) {
  return request({
    url: '/api/asset/management/image_info/findRuleEcho',
    method: 'get',
    params: data
  })
}
