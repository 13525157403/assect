 ...
 */
export function getReturnVisitTaskByPage(query) {
  return request({
    url: '/api/asset/management/postLoanReturnVisit/getReturnVisitTaskByPage',
    method: 'get',
    params: query
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function getReturnVisitRecordPage(query) {
  return request({
    url: '/api/asset/management/postLoanReturnVisit/getReturnVisitResultByPage',
    method: 'get',
    params: query
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function getReturnVisitListByPage(query) {
  return request({
    url: '/api/asset/management/postLoanReturnVisit/getReturnVisitListByPage',
    method: 'get',
    params: query
  })
}
