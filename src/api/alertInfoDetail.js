...
// 地址评分-人数数据卡-详情页分页列表
// 地址评分-评分数据卡-详情页分页列表
export function addressScoreDataCardDetails(query, url) {
  return request({
    url: `/api/asset/management/monitor-data-info/stats/AS/dataCard/${url}/detail/page`,
    method: 'get',
    params: query
  })
}
...
export function addressScoreDataCardDownExport(query, url) {
  return request({
    url: `/api/asset/management/addressScore/dataCard/${url}/detail/export`,
    method: 'get',
    params: query,
    responseType: 'blob'
  })
...
// 风险标签-人数数据卡-详情页分页列表
// 风险标签-评分数据卡-详情页分页列表
export function riskLabelDataCardDetails(query, url) {
  return request({
    url: `/api/asset/management/monitor-data-info/stats/RT/dataCard/${url}/detail/page`,
    method: 'get',
    params: query
  })
}
...
export function riskLabelDataCardDownExport(query, url) {
  return request({
    url: `/api/asset/management/monitor-data-info/stats/RT/dataCard/${url}/detail/export`,
    method: 'get',
    params: query,
    responseType: 'blob'
  })
...
// 反欺诈评分-累计评分数据
export function FraudDataScore(query) {
  return request({
    url: `/api/asset/management/monitor-data-info/stats/TF/dataCard/score/detail/page`,
    method: 'get',
    params: query
  })
}
...
// 反欺诈评分-累计评分数据导出
export function FraudDataScoreExport(query) {
  return request({
    url: `/api/asset/management/monitor-data-info/stats/TF/dataCard/score/detail/export`,
    method: 'get',
    params: query,
    responseType: 'blob'
  })
