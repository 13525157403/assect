...
export function getMonitorDetail(data) {
  return request({
    url: '/api/asset/management/taskManagementDetailInfo/getMonitorDetail',
    method: 'get',
    params: data
  })
}
...
export function getRuleListByTaskId(query) {
  return request({
...
export function viewListByPage(data) {
  return request({
    url: '/api/asset/management/taskManagementDetailInfo/viewListByPage',
    method: 'get',
    params: data
  })
}
...
export function batchExport(data) {
  return request({
    url: '/api/asset/management/taskManagementDetailInfo/batchExport',
    method: 'get',
    responseType: 'blob',
    params: data
  })
...
export function searchExport(data) {
  return request({
    url: '/api/asset/management/taskManagementDetailInfo/searchExport',
    method: 'get',
    responseType: 'blob',
    params: data
  })
...
export function writeoffloanList(q) {
  return request({
    url: `/api/asset/management/monitor-data-info/stats/WO/dataCard/loan/detail/page`,
    method: 'get',
    params: q
  })
}
